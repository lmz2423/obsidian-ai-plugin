...
import { PlaceholderPlugin,aiKeymap } from './ViewPlugins/PlaceholderPlugin';
...
export default class AIPlugin extends Plugin {
    ...
    async onload() {
		...
		try {
			console.log('Registering extensions:', PlaceholderPlugin, aiKeymap);
			this.registerEditorExtension([PlaceholderPlugin]);
		} catch (error) {
			console.error('PlaceholderPlugin registration failed:', error);
		}
